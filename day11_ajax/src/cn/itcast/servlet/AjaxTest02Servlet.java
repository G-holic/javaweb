...
public class AjaxTest02Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        CommonResult ok = CommonResult.ok().setResultData(new Employee(101, "内卷", 0, 500.00));
        // ok内携带flag的值和resultData的值
        String s = new Gson().toJson(ok);
        System.out.println("s = " + s);
        // s = {"flag":true,"resultData":{"id":101,"name":"内卷","gender":0,"salary":500.0}}
        // 需要将s返回
